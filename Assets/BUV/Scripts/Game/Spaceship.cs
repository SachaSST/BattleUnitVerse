...
#pragma warning restore 0109
        ...
        public void Start()
        {
            ...
            {
                r.material.color = BUVGame.GetColor(photonView.Owner.GetPlayerNumber());
            }
        }
        ...
        {
            yield return new WaitForSeconds(BUVGame.PLAYER_RESPAWN_TIME);
        ...
        public void DestroySpaceship()
        {
            ...
            {
                object lives;
                if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(BUVGame.PLAYER_LIVES, out lives))
                {
                    PhotonNetwork.LocalPlayer.SetCustomProperties(new Hashtable {{BUVGame.PLAYER_LIVES, ((int) lives <= 1) ? 0 : ((int) lives - 1)}});
